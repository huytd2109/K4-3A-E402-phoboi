...
**Lớp:** 3A · **Phòng:** E402 · **Cụm:** C3 · **Track:** B1

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
| Trịnh Đức Huy | 2A202602865 | Lead Team & Backend Engineer | Source repository, Conflict resolver |
| Trịnh Hoàng Tùng | 2A202602937 | QA & Security Engineer | Test suite, Security module, Golden set |
| Đỗ Quốc An | 2A202602892 | UX & Documentation | Docs, README, CLI demo, UI mockup |
| Nguyễn Hoàng Sơn | 2A202602457 | AI Engineer | Spec, Evidence mining, Core pipeline, Eval |
