...
class _RoutingOutput(BaseModel):
    """The only structured data Gemini is allowed to return."""
...
class GeminiIntentRouter:
    ...
    def classify(self, text: str) -> RouterResult:
        ...
        try:
            response = client.models.generate_content(
                ...
                config=types.GenerateContentConfig(
                    ...
                    response_schema=_RoutingOutput,
        ...
        if isinstance(parsed, _RoutingOutput):
            output = parsed
        elif response.text:
        ...
        logistics_type = output.logistics_type or self._logistics_type(intents)
        return RouterResult(
            intents=intents,
